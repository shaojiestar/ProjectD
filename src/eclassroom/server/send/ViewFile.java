...
public class ViewFile extends JFrame implements DropTargetListener{
	...
	public JLabel getLblShowName() {
		return lblShowName;
	}
	
	public void setLblShowName(JLabel lblShowName) {
		this.lblShowName = lblShowName;
	}
	...
	private void init() {
		...
		lblShow.setBounds(10, 21, 288, 107);
		pnlShow.add(lblShow);
		
		lblShowName = new JLabel();
		lblShowName.setVerticalAlignment(SwingConstants.TOP);
		lblShowName.setBackground(Color.WHITE);
		lblShowName.setBounds(304, 21, 93, 107);
		pnlShow.add(lblShowName);
		...
		try {
			if (dtde.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
				...
				while (iterator.hasNext()) {
					...
					this.lblShowName.setText(file.getName());
				}
